...
public final class AndroidBlazeRules implements Kind.Provider {
  ...
  public enum RuleTypes {
    ...
    SQ_ANDROID_BINARY("sq_android_application", LanguageClass.ANDROID, RuleType.BINARY),
    SQ_ANDROID_LIBRARY("sq_android_library", LanguageClass.ANDROID, RuleType.LIBRARY);
