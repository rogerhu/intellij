...
public abstract class BaseBlazeModuleSystem implements AndroidModuleSystem, BlazeClassFileFinder {
  private static final Logger logger = Logger.getInstance(BaseBlazeModuleSystem.class);
  protected Module module;
  protected final Project project;
  protected SampleDataDirectoryProvider sampleDataDirectoryProvider;
  protected BlazeClassFileFinder classFileFinder;
  protected final boolean isWorkspaceModule;

  // @Override #api 3.6
  protected BaseBlazeModuleSystem(Module module) {
    this.module = module;
